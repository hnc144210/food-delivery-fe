...
export function ProductCard_Large({
  food,
  base_price,
  discount_price,
  prep_time,
    ...
    >
      ...
      <View style={{ paddingVertical: 7, paddingHorizontal: 15 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <Text style={{ fontSize: 18, fontWeight: "bold", color: "#B22203" }}>
            {discount_price}đ
          </Text>
          <View style={{ width: 10 }} />
...
export function ProductCard_Medium({ food, discount_price }: ProductCardData) {
  ...
  return (
    ...
    >
      <Image
        source={{ uri: food.image }}
        style={{ height: 145, width: 145, borderRadius: 20 }}
      />
...
export function ProductCard_Small({
  food,
  base_price,
  discount_price,
  prep_time,
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 20, fontWeight: "bold", color: "#B22203" }}>
...
export function ProductCard_ForDriver({
  name,
  quantity,
  selected_options,
}: OrderitemsData) {
