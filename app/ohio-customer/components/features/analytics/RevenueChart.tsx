...
import type { RevenueData } from '@/mock/analytics';
          ...
          return (
            <View key={i} style={styles.col}>
              <View style={styles.track}>
                <View style={[styles.bar, { height: `${Math.max(pct * 100, 5)}%` }]} />
              </View>
...
const styles = StyleSheet.create({
  ...
  col:   { flex: 1, alignItems: 'center', height: '100%', justifyContent: 'flex-end', gap: 6 },
  track: { flex: 1, width: '100%', justifyContent: 'flex-end' },
  bar:   { backgroundColor: ORANGE, borderRadius: 5, width: '100%', opacity: 0.9 },
