...
import type { TopItem } from '@/mock/analytics';
...
const styles = StyleSheet.create({
  container: { gap: 10 },
  row:       { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#fafafa', borderRadius: 12, padding: 10 },
  ...
  badge:     { alignItems: 'center', backgroundColor: '#FEF3E8', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
