    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.wallet}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', height: 50, gap: 10, backgroundColor: '#cfcfcfff', borderRadius: 12 }} onPress={() => router.push('/(shipper)/wallethistory')}>
                    <Text style={{ fontSize: 14, fontWeight: 'bold' }}>Lịch sử giao dịch</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', height: 50, gap: 10, backgroundColor: '#cfcfcfff', borderRadius: 12 }} onPress={() => router.push('/(shipper)/topup')}>
                    <Text style={{ fontSize: 14, fontWeight: 'bold' }}>Nạp tiền vào ví</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', height: 50, gap: 10, backgroundColor: '#f36a4eff', borderRadius: 12 }} onPress={() => router.push('/(shipper)/withdraw')}>
