        ...
        >
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={{ fontSize: 22, fontWeight: 'bold', color: '#EE4D2D' }}>Định danh điện tử</Text>
                </View>
                <ScrollView>
                    <View style={{ padding: 20, width: '100%' }}>
                        <Text style={{ fontSize: 30, fontWeight: 'bold', marginBottom: 5 }}>Xác minh danh tính</Text>
                        ...
                        <Text style={{ fontSize: 22, fontWeight: 'bold', marginBottom: 10 }}>Chứng minh nhân dân/CCCD</Text>
                        ...
                        <Text style={{ fontSize: 22, fontWeight: 'bold', marginBottom: 10 }}>Thông tin cá nhân</Text>
                ...
                <View style={styles.buttonFooter}>
                    <TouchableOpacity
                        style={[
                            styles.submitButton,
                            (!citizenId.trim() || !fullName.trim() || !dob.trim() || !frontImage || !backImage || !selfie) && styles.submitButtonDisabled
                        ]}
                        onPress={handleSave}
                        disabled={!citizenId.trim() || !fullName.trim() || !dob.trim() || !frontImage || !backImage || !selfie || submitting}
                    >
                        {submitting ? (
                            <ActivityIndicator size="small" color="white" />
                        ) : (
                            <View style={styles.buttonContent}>
                                <Text style={styles.submitButtonText}>Xác minh danh tính</Text>
                            </View>
                        )}
                    </TouchableOpacity>
                </View>
