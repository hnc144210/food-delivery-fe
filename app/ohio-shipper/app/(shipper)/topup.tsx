      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.subtitleText}>
            Nạp thêm tiền vào tài khoản tài xế để nhận nhiều đơn hàng hơn.
          </Text>
        </View>
        ...
        <View style={styles.smallcontainer}>
          <Text style={[styles.sectionLabel, { marginBottom: 5 }]}>
            ...
            <View style={styles.paymentLeft}>
              ...
              <View>
                ...
                <Text style={styles.paymentDesc}>
                  Thanh toán qua ngân hàng nội địa/QR
                </Text>
              </View>
            </View>
            <Ionicons
          ...
          >
            <View style={styles.paymentLeft}>
              ...
              <View>
                ...
                <Text style={styles.paymentDesc}>
                  Liên kết ví nhanh chóng, an toàn
                </Text>
              </View>
            </View>
            <Ionicons
